...
if (!isAuthenticated() || !hasRole('usuario')) redirect('/auth/login.php');
?>
<div class="flex flex-col items-center justify-center min-h-[60vh]">
    <div class="bg-white rounded-2xl shadow-2xl p-8 border border-cadet/40 w-full max-w-xl mx-auto text-center">
        <h1 class="text-2xl font-bold text-primary mb-4">
            <i class="fas fa-user-circle text-accent"></i> ¡Bienvenido/a!
        </h1>
        <p class="text-lg text-darkpurple mb-6">Has iniciado sesión como <span class="font-semibold">usuario</span>. Solo tienes acceso a tu perfil personal.</p>
